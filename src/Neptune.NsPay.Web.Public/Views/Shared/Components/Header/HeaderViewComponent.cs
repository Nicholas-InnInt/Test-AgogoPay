...
using Neptune.NsPay.Web.Public.Startup;
using Neptune.NsPay.Web.Session;
using Neptune.NsPay.Web.UiCustomization;

namespace Neptune.NsPay.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : NsPayViewComponent
    {
