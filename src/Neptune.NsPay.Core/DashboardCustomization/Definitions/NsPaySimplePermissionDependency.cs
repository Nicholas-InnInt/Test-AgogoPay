...
/// </summary>
public class NsPaySimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public NsPaySimplePermissionDependency()
    {
    ...
    public NsPaySimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public NsPaySimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
