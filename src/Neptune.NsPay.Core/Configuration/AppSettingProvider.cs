...
namespace Neptune.NsPay.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!NsPayConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        NsPayConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        NsPayDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        NsPayDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = NsPayDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{NsPayDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{NsPayDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = NsPayDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = NsPayDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    NsPayDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = NsPayDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{NsPayDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{NsPayDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = NsPayDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            //new Widget
                            //{
                            //    WidgetId = NsPayDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            //{
                            //    WidgetId =
                            //        NsPayDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId = NsPayDashboardCustomizationConsts.Widgets.Tenant
                                    .MerchantBillsSummary, // MerchantBills Summary
                                Height = 20,
                                Width = 12,
                                PositionX = 0,
                                PositionY = 1
