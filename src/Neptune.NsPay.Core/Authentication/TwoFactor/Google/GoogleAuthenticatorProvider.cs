...
namespace Neptune.NsPay.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : NsPayServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("NsPay", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
