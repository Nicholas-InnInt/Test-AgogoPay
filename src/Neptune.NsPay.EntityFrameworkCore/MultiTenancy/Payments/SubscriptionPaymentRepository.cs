...
{
    public class SubscriptionPaymentRepository : NsPayRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<NsPayDbContext> dbContextProvider)
