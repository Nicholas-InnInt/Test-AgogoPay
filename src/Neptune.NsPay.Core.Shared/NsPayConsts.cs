...
{
    public class NsPayConsts
    {
        public const string LocalizationSourceName = "NsPay";
        
        /// <summary>
        /// Name of the product if the app itself is sold as a SAAS product.
        /// </summary>
        public const string ProductName = "NsPay";
        ...
        public const string FileDownloadExcelPath = "/File/DownloadTempFile?fileToken={0}&fileType={1}&fileName={2}";
