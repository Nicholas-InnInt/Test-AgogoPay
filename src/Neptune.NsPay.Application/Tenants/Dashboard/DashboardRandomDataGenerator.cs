...
namespace Neptune.NsPay.Tenants.Dashboard
{
    public static class DashboardRandomDataGenerator
    {
        ...
        public static List<MemberActivity> GenerateMemberActivities()
        {
            ...
            {
                new MemberActivity("Brain", NsPayConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "015-boy-6.svg"),

                new MemberActivity("Jane", NsPayConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%","017-girl-8.svg"),

                new MemberActivity("Tim", NsPayConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%", "004-boy-1.svg"),

                new MemberActivity("Kate", NsPayConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
