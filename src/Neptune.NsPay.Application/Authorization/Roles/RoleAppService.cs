...
namespace Neptune.NsPay.Authorization.Roles
{
    ...
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles, AppPermissions.Pages_Merchant_Users_Roles)]
    public class RoleAppService : NsPayAppServiceBase, IRoleAppService
    {
