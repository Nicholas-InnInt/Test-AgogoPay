...
namespace Neptune.NsPay.Authorization.Users
{
    ...
    public class UserAppService : NsPayAppServiceBase, IUserAppService
    {
        ...
        public async Task<GetUserForEditOutput> GetUserForEdit(NullableIdDto<long> input)
        {
            ...
            var userMerchantDtos = await _merchantRepository.GetAll()
                .OrderBy(r => r.CreationTime)
                .Select(r => new UserMerchantDto
                {
                    MerchantId = r.Id,
                    MerchantName = r.Name,
                    MerchantDisplayName = r.Name,
                })
                .ToArrayAsync();
