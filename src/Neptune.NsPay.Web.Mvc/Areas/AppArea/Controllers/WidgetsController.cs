...
namespace Neptune.NsPay.Web.Areas.AppArea.Controllers
{
    [Area("AppArea")]
    [AbpMvcAuthorize]
    public class WidgetsController : NsPayControllerBase
    {
        #region Host
        ...
        [AbpMvcAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
        public IActionResult MerchantBillsSummary()
        {
            return PartialView("Components/CustomizableDashboard/Widgets/MerchantBillsSummary");
        }
        #endregion
    }
}
