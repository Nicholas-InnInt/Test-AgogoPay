...
namespace Neptune.NsPay.Web.Areas.AppArea.Views.Shared.Components.AppAreaMenu
{
    public class AppAreaMenuViewComponent : NsPayViewComponent
    {
        private readonly IUserNavigationManager _userNavigationManager;
        private readonly IAbpSession _abpSession;
        private readonly TenantManager _tenantManager;

        public AppAreaMenuViewComponent(
            ...
            string topMenuClass = "menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0")
        {
            ...
            {
                Menu = await _userNavigationManager.GetMenuAsync(AppAreaNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
                Height = height,
            ...
            var subscriptionManagement = FindMenuItemOrNull(model.Menu.Items, AppAreaPageNames.Tenant.SubscriptionManagement);
