(function () {
  $(function () {
    ...
    var _selectAnEntity = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/DynamicProperty/SelectAnEntityModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/DynamicProperties/_SelectAnEntityModal.js',
    ...
    var _manageDynamicEntityPropertyModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/DynamicEntityProperty/ManageModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/AppArea/Views/_Bundles/dynamic-entity-properties-manage-modal.min.js',
