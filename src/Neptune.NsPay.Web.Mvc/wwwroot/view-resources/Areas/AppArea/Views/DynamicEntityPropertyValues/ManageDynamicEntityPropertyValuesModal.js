(function () {
  ...
  app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/AppArea/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',
