(function () {
    let _addFromDifferentTenantModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppArea/Chat/AddFromDifferentTenantModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Chat/_AddFromDifferentTenantModal.js',
    ...
    app.modals.AddFriendModal.create = function (lookupOptions) {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'AppArea/Chat/AddFriendModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Chat/_AddFriendModal.js',
