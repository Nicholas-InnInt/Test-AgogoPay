(function () {
    $(function () {
        ...
        const _editPersonModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppArea/SubscriptionManagement/ShowDetailModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/SubscriptionManagement/_ShowDetailModal.js',
        ...
        function createOrShowInvoice(data) {
            ...
            if (invoiceNo) {
                window.open('/AppArea/Invoice?paymentId=' + paymentId, '_blank');
            } else {
                _invoiceService
                    .createInvoice({
