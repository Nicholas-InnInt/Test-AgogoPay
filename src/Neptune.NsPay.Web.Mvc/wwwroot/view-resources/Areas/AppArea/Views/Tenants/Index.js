(function () {
  $(function () {
    ...
    var _entityTypeFullName = 'Neptune.NsPay.MultiTenancy.Tenant';
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Tenants/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Tenants/_CreateModal.js',
      modalClass: 'CreateTenantModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Tenants/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Tenants/_EditModal.js',
      modalClass: 'EditTenantModal',
    });

    var _featuresModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Tenants/FeaturesModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Tenants/_FeaturesModal.js',
