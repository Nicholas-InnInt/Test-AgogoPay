(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/WebhookSubscription/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/WebhookSubscriptions/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  window.location = '/AppArea/WebhookSubscription/WebhookEventDetail/' + data.record.webhookEventId;
                },
              },
            ],
          },
