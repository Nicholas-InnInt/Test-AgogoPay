(function () {
  $(function () {
    ...
    var _createModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Editions/CreateModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Editions/_CreateModal.js',
      modalClass: 'CreateEditionModal',
    });

    var _editModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Editions/EditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Editions/_EditModal.js',
      modalClass: 'EditEditionModal',
    });

    var _moveTenantsToAnotherEditionModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Editions/MoveTenantsToAnotherEdition',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
