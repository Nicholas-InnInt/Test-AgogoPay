(function () {
    $(function () {
        ...
        var dataTable = _$payOrdersTable.DataTable({
            ...
            ordering: false,
            listAction: {
                ajaxFunction: _payOrdersService.getAllCrypto,
                inputFilter: function () {
                    return {
                        filter: $('#PayOrdersCryptoTableFilter').val(),
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return `<span class="font-weight-bold">${payType[full.payOrder.payTypeStr]?.title ?? 'Unknown'}</span>`;
                    }
                },
                {
                    targets: 7,
                    ...
                    render: function (data, type, full, meta) {
                        return `<div>${full.payMent.cryptoWalletAddress}</div>`;
                    }
                },
                {
                    targets: 8,
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full.payOrder.orderMark) {
                            html += `<div>${app.localize('OrderMark')}: ${full.payOrder.orderMark}</div>`
