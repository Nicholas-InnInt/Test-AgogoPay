  ...
  app.modals.MySettingsModal = function () {
    ...
    this.init = function (modalManager) {
      ...
      let twoFactorModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppArea/Profile/TwoFactorAuthenticationModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Profile/_TwoFactorAuthenticationModal.js',
      ...
      var viewRecoveryCodesModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppArea/Profile/ViewRecoveryCodesModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Profile/_ViewRecoveryCodesModal.js',
      ...
      var removeAuthenticatorModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppArea/Profile/RemoveAuthenticatorModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Profile/_RemoveAuthenticatorModal.js',
      ...
      var smsVerificationModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppArea/Profile/SmsVerificationModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Profile/_SmsVerificationModal.js',
