(function () {
  $(function () {
    ...
    var _createOrEditModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Languages/CreateOrEditModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Languages/_CreateOrEditModal.js',
          ...
          rowAction: {
            ...
            items: [
              ...
              },
              {
                ...
                action: function (data) {
                  document.location.href = abp.appPath + 'AppArea/Languages/Texts?languageName=' + data.record.name;
                },
              },
              {
