    ...
    getFormattedMessages: function (messages) {
        $.each(messages, function (index, message) {
            ...
            if (message.message.startsWith('[image]')) {
                ...
                var imageUrl = abp.appPath + 'AppArea/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                ...
                var fileUrl = abp.appPath + 'AppArea/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
                var uploadedFileMsg =
                    '<a href="' +
                    fileUrl +
...
(function ($) {
    $(function () {
        ...
        var url = abp.appPath + 'AppArea/Chat/UploadFile';
