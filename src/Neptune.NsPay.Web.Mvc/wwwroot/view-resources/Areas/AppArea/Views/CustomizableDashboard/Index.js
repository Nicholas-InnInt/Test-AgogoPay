$(function () {
  ...
  var _addWidgetModal = new app.ModalManager({
    viewUrl: abp.appPath + 'AppArea/' + $('#DashboardName').val() + '/AddWidgetModal',
    scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/CustomizableDashboard/_AddWidgetModal.js',
