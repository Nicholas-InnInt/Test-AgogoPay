var DynamicEntityPropertyManager = (function () {
  return function () {
    ...
    let _dynamicPropertiesModal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal',
      scriptUrl:
        abp.appPath +
        'view-resources/Areas/AppArea/Views/_Bundles/manage-dynamic-entity-property-values-modal.min.js',
