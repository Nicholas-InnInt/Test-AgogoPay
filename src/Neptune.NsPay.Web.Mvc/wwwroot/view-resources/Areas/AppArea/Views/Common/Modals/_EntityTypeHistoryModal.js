(function () {
  app.modals.EntityTypeHistoryModal = function () {
    ...
    function showEntityChangeDetails(entityChange) {
      var entityChangeDetailModal = new app.ModalManager({
        viewUrl: abp.appPath + 'AppArea/AuditLogs/EntityChangeDetailModal',
  ...
  app.modals.EntityTypeHistoryModal.create = function () {
    return new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Common/EntityTypeHistoryModal',
      scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Common/Modals/_EntityTypeHistoryModal.js',
