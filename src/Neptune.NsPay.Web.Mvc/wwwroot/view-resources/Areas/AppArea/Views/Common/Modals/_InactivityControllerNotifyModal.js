(function () {
  ...
  app.modals.InactivityControllerNotifyModal.create = function () {
    var modal = new app.ModalManager({
      viewUrl: abp.appPath + 'AppArea/Common/InactivityControllerNotifyModal',
      scriptUrl:
        abp.appPath + 'view-resources/Areas/AppArea/Views/Common/Modals/_InactivityControllerNotifyModal.js',
