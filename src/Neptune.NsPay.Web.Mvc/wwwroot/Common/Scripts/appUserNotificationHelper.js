...
(function ($) {
  app.UserNotificationHelper = (function () {
    return function () {
      ...
      /* Example:
            abp.notifications.messageFormatters['Neptune.NsPay.MyNotificationDataType'] = function(userNotification) {
      ...
      function getUrl(userNotification) {
        switch (userNotification.notification.notificationName) {
          case 'App.NewUserRegistered':
            return '/AppArea/users?filterText=' + userNotification.notification.data.properties.emailAddress;
          case 'App.NewTenantRegistered':
            return '/AppArea/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
      ...
      var openSettingsModal = function () {
        new app.ModalManager({
          viewUrl: abp.appPath + 'AppArea/Notifications/SettingsModal',
          scriptUrl: abp.appPath + 'view-resources/Areas/AppArea/Views/Notifications/_SettingsModal.js',
