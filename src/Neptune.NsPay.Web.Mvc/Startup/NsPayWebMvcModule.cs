...
namespace Neptune.NsPay.Web.Startup
{
    ...
    public class NsPayWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public NsPayWebMvcModule(IWebHostEnvironment env)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Navigation.Providers.Add<AppAreaNavigationProvider>();
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NsPayWebMvcModule).GetAssembly());
        }
