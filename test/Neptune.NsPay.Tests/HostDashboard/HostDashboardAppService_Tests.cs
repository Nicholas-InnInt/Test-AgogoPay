...
using Neptune.NsPay.MultiTenancy.HostDashboard;
...
namespace Neptune.NsPay.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(NsPayDbContext context, SubscriptionPayment subscriptionPayment)
        {
