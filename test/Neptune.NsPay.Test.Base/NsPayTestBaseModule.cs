...
using Neptune.NsPay.Test.Base.DependencyInjection;
using Neptune.NsPay.Test.Base.UiCustomization;
using Neptune.NsPay.Test.Base.Url;
using Neptune.NsPay.Test.Base.Web;
...
namespace Neptune.NsPay.Test.Base
{
    ...
    public class NsPayTestBaseModule : AbpModule
    {
        public NsPayTestBaseModule(NsPayEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.EntityHistory.Selectors.Add("NsPayEntities", typeof(User), typeof(Tenant));
        }
